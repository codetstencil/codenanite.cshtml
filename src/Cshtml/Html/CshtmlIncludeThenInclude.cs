...
namespace ZeraSystems.CodeNanite.Cshtml
{
    ...
    {
        "Zera Systems Inc.",                    // 0
        "Returns a generated Cshtml Edit",    // 1
        "..",                                   // 2
        "1.0",                                  // 3
        "CshtmlIncludeThenInclude",                         // 4
        "ZeraSystems.CodeNanite.Cshtml",               // 5
        "03/03/2018",                           // 6
        "CS_CSHTML_INCLUDE_THENINCLUDE",                        // 7
        "1",                                    // 8
        "",                                     // 9
        ""                                      // 10
    })]
    public partial class CshtmlIncludeThenInclude : ExpansionBase, ICodeStencilCodeNanite
    {
