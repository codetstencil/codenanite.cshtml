...
namespace ZeraSystems.CodeNanite.Cshtml
{
    ...
    {
        "Zera Systems Inc.",                    // 0
        "Returns a generated Form Group class",    // 1
        "..",                                   // 2
        "1.0",                                  // 3
        "CshtmlFormGroup",                         // 4
        "ZeraSystems.CodeNanite.Cshtml",               // 5
        "10/10/2018",                           // 6
        "CS_CSHTML_FORM_GROUP",                        // 7
        "1",                                    // 8
        "",                                     // 9
        ""                                      // 10
    })]
    public partial class CshtmlFormGroup : ExpansionBase, ICodeStencilCodeNanite
    {
        ...
        public void ExecutePlugin()
        {
            ...
            //if (Output.IsBlank())
            //    Output = "**** Table Needs to be passed ****";
        }
    }
}