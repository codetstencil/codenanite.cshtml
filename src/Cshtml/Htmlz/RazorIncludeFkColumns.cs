...
namespace ZeraSystems.CodeNanite.Cshtml
{
    ...
    {
        "ZeraSystems Inc.",                    // 0
        "Returns a generated string of columns in an include linq" ,    // 1
        "..",                                   // 2
        "1.0",                                  // 3
        "RazorIncludeFkColumns",                         // 4
        "ZeraSystems.CodeNanite.Cshtml",               // 5
        "15/05/2019",                           // 6
        "CS_RAZOR_INCLUDE_FKCOLS",                        // 7
        "1",                                    // 8
        "",                                     // 9
        ""                                      // 10
    })]
    public partial class RazorIncludeFkColumns : ExpansionBase, ICodeStencilCodeNanite
    {
        ...
        public void ExecutePlugin()
        {
            ...
            MainFunction();
            Output = ExpandedText.ToString().TrimEnd('\r', '\n');
        }
    }
}