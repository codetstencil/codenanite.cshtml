...
namespace ZeraSystems.CodeNanite.Cshtml
{
    ...
    {
        "ZeraSystems Inc.",                    // 0
        "Returns a search string to be used by the .cs",    // 1
        "..",                                   // 2
        "1.0",                                  // 3
        "RazorIndexSearchString",                         // 4
        "ZeraSystems.CodeNanite.Cshtml",               // 5
        "05/05/2019",                           // 6
        "CS_RAZOR_INDEX_SEARCH",                        // 7
        "1",                                    // 8
        "",                                     // 9
        ""                                      // 10
    })]
    public partial class RazorIndexSearchString : ExpansionBase, ICodeStencilCodeNanite
    {
